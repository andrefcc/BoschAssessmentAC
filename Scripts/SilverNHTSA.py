...
BRONZE_PATH = Path("C:/Users/e709117/Downloads/Assessment/Bronze/Safercar_data.csv")
SILVER_FOLDER = Path("C:/Users/e709117/Downloads/Assessment/Silver")
SILVER_PARQUET = SILVER_FOLDER / "Safercar_data.parquet"
...
UpperCaseColumns = ["MODEL", "MAKE", "DRIVE_TRAIN"]
for col in UpperCaseColumns:
    if col in df.columns:
        df[col] = df[col].astype("string").str.strip().str.upper() 

# 8.2) Rename join columns
df = df.rename(columns={"MAKE": "MANUFACTURER", "DRIVE_TRAIN": "DRIVETRAIN", "MODEL_YR": "MODEL_YEAR"})

# 8.3) Standardize column "DRIVETRAIN" values
drive_map = {
    "AWD": "AWD",
    "RWD": "RWD",
    "FWD": "FWD",
